...
GlobalConfig::$CONNECTION_SETTING->DBName = "semed_db";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "semed-ni";
...
/** the root url of the application with trailing slash, for example http://localhost/agenda/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'agenda/';
