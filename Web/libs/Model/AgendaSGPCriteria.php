...
require_once("DAO/AgendaSGPCriteriaDAO.php");

/**
 * The AgendaSGPCriteria class extends AgendaSGPDAOCriteria and is used
 ...
 * @version 1.0
 */
class AgendaSGPCriteria extends AgendaSGPCriteriaDAO
{
