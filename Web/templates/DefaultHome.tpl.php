<?php
	$this->assign('title','AgendaSGP'); // Barra superior da janela
...
<h1>
	...
	<div class="modal hide fade" id="agendaSGPDetailDialog">
		...
		<div class="modal-footer">
			...
			<button id="saveAgendaSGPButton" class="btn btn-primary">Salvar mudanças</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newAgendaSGPButton" class="btn btn-primary">Adicionar evento</button>
	</p>
