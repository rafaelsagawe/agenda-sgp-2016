/**
 * backbone model definitions for agenda
 */
...
/**
 * AgendaSGP Backbone Model
 */
model.AgendaSGPModel = Backbone.Model.extend({
	urlRoot: 'api/agendasgp',
	idAttribute: 'id',
	id: '',
	data: '',
	horario: '',
...
/**
 * AgendaSGP Backbone Collection
 */
model.AgendaSGPCollection = model.AbstractCollection.extend({
	url: 'api/agendasgps',
	model: model.AgendaSGPModel
});
